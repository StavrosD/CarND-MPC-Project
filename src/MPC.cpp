...
// COMPLETED: Set the timestep length and duration
size_t N = 10;
double dt = 0.1;
...
public:
	...
	void operator()(ADvector &fg, const ADvector &vars)
	{
		...
		for (int t = 1; t < N; t++) {
			...
			// I used the complete form of the equation, the simplified form did not give good results
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs)
{
	...
	// COMPLETED: Set the number of model variables (includes both states and inputs).
	...
	// COMPLETED: Set the number of constraints
	...
	// COMPLETED: Set lower and upper limits for variables.
	...
	// COMPLETED: Return the first actuator values. The variables can be accessed with
	// `solution.x[i]`.
	//
	...
	// store the destination points calculated by MPC
	for (int i = 0; i < N - 1; i++)
	{
